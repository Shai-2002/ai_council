    ...
    <div className="flex-1 flex flex-col h-full bg-zinc-50 dark:bg-zinc-950 overflow-y-auto">
      <div className="p-6 md:p-10 max-w-6xl mx-auto w-full space-y-8">
        <div className="flex items-center justify-between">
          ...
          <Button className="bg-indigo-600 hover:bg-indigo-700 text-white shadow-sm border-0" onClick={() => setIsCreateOpen(true)}>
        ...
        {loading ? (
          <div className="flex items-center justify-center py-20 text-zinc-400">Loading projects...</div>
        ) : projects.length === 0 ? (
          <div className="text-center py-20 text-zinc-500">
            <Folder className="h-12 w-12 mx-auto mb-4 opacity-30" />
            <p className="text-lg font-medium mb-1">No projects yet</p>
            <p className="text-sm">Create a project to organize your chats and files.</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="flex items-center gap-4 text-xs font-medium text-zinc-500 dark:text-zinc-400 pt-4 border-t border-zinc-100 dark:border-zinc-800/50 mt-auto">
                  <div className="flex items-center gap-1.5" title="Chats">
                    <MessageSquare className="h-4 w-4" /> {project.chat_count || 0}
                  </div>
                  <div className="flex items-center gap-1.5" title="Files">
                    <FileText className="h-4 w-4" /> {project.file_count || 0}
                  </div>
